<section id="profile">
    ...
    <div class="form-group">
      <?php echo $this->Form->input("oldpassword" ,array("type"=>"password",'label' => 'Contraseña anterior','div' => false,'class'=>"form-control inp_edit",'error' => array('attributes' => array('wrap' => 'div','class' => 'error_message')) ))?>
		...
		<div class="form-group">
      <?php echo $this->Form->input("password" ,array("type"=>"password",'label' => 'Nueva contraseña','div' => false,'class'=>"form-control inp_edit",'error' => array('attributes' => array('wrap' => 'div','class' => 'error_message')) ))?>
    </div>
    <div class="form-group">
      <?php echo $this->Form->input("cpassword" ,array("type"=>"password",'label' => 'Repita nueva contraseña','div' => false,'class'=>"form-control inp_edit",'error' => array('attributes' => array('wrap' => 'div','class' => 'error_message')) ))?>
    </div>
